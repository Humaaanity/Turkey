...
export default class Ref extends Component{
    render() {
        return (
         ...
         <div className="bg-gradient-to-r from-[#423D8A] to-[#413D8A] rounded-[40px] w-[1645px] h-[450px] block  shadow-2xl">
            ...
            <img src={People} alt="" className="absolute translate-x-[960px] translate-y-[-237px]"/>
